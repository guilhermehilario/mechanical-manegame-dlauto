...
/**
 * Ícones de navegação (stroke, 24px, herdam `currentColor`). Traços simples
 * para um visual sóbrio; nenhum pacote externo é necessário.
 */
...
export function IconDashboard(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M3 13h8V3H3zM13 21h8v-8h-8zM13 9h8V3h-8zM3 21h8v-4H3z" />
    </svg>
  );
}
